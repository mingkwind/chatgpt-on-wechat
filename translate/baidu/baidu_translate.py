...
class BaiduTranslator(Translator):
    def __init__(self) -> None:
        ...
        self.appid = str(conf().get("baidu_translate_app_id"))
        self.appkey = str(conf().get("baidu_translate_app_key"))
        ...
        while retry_cnt:
            ...
            if errcode != "52000":
                if errcode == "52001" or errcode == "52002":
                    ...
                    if result["error_msg"]=='INVALID_CLIENT_IP':
                        print("You current IP: ",result["data"])
